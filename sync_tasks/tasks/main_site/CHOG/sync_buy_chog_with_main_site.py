...
class BUY_CHOG:
    ...
    def sync_response_buy_chog(self):
        ...
        try:
            ...
            logger.error(f"❌ Erorr in response: {e}")
    ...
    def sign_and_send(self,
        ...
        try:
            ...
            balance_chog = ins.get_all_balances()
            balance_mon = ins.get_mon_balance()
            
            logger.success(f"🔄 Succes buy $CHOG in MAIN-SITE, {amount} MON | Wallet {self.address} |" 
